...
**Structural quality:** ${quality.unexpectedObjectOverlaps.length} object overlaps · ${quality.routeObjectIntersections.length} route–object intersections · ${quality.labelObjectOverlaps.length} label–object overlaps · ${quality.labelLabelOverlaps.length} label–label overlaps · ${quality.unexpectedRouteOverlaps.length} unexpected shared runs · ${quality.routeCrossings.length} crossings · ${quality.routeTitleCrossings.length} title crossings · ${quality.labelDecorOverlaps.length} label–decor overlaps
